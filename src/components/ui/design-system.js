...
export const typography = {
  ...
  gradient: {
    primary:
      "bg-gradient-to-r from-fuchsia-500 to-purple-400 text-transparent bg-clip-text",
    secondary:
      "bg-gradient-to-r from-fuchsia-400 to-purple-500 text-transparent bg-clip-text",
  },
}
...
export const cardStyles = {
  primary:
    "bg-white/10 backdrop-blur-lg p-6 border border-white/20 text-white shadow-xl hover:shadow-fuchsia-700/30 hover:border-fuchsia-400 transition-all duration-300 rounded-2xl",
  secondary:
    "bg-white/5 hover:bg-white/10 p-6 rounded-2xl border border-purple-900 backdrop-blur-xl shadow-md hover:shadow-purple-700/30 transition-all duration-500 hover:scale-105",
  process:
    "group p-8 rounded-2xl border border-purple-800 bg-[#1a001f]/60 backdrop-blur-md shadow-lg hover:shadow-purple-500/30 transition-all duration-500 hover:scale-105 text-center",
}
...
export const content = {
  ...
  sections: {
    ...
    about: {
      ...
      subtitle:
        "We're a team of passionate innovators dedicated to transforming businesses through cutting-edge technology.",
    },
    contact: {
      title: "Get In Touch",
...
export const formStyles = {
  input:
    "w-full px-4 py-3 bg-white/10 border border-purple-700 rounded-lg text-white placeholder-purple-300 focus:outline-none focus:ring-2 focus:ring-fuchsia-400 focus:border-transparent backdrop-blur-sm",
  textarea:
    "w-full px-4 py-3 bg-white/10 border border-purple-700 rounded-lg text-white placeholder-purple-300 focus:outline-none focus:ring-2 focus:ring-fuchsia-400 focus:border-transparent backdrop-blur-sm resize-none",
...
export const utilities = {
  ...
  focusRing:
    "focus:outline-none focus:ring-2 focus:ring-fuchsia-400 focus:ring-offset-2 focus:ring-offset-black",
}

// -----------------------------------------------------------------------------------
// Client‐only FadeIn component you can use across your app to prevent “fade‐away”:
// -----------------------------------------------------------------------------------
export function FadeIn({ children, delay = 0, ...props }) {
  return (
    <motion.div
      ...
      animate={{ opacity: 1, y: 0 }}          // lock final state
